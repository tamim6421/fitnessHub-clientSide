...
const ProfileSetting = () => {
  ...
  const updateProfile = (e) => {
    ...
    axiosSecure.put(`/users/${getMember?._id}`, updateInfo).then((res) => {
  ...
  return (
    <div className="min-h-screen overflow-hidden mb-20">
        ...
        <div data-aos="fade-up-left shadow-lg ">
          ...
          <div className="items-center text-center">
            <form onSubmit={updateProfile}>
              ...
              <button className="btn bg-purple-600 mt-10 text-white btn-outline ">
                Update Profile{" "}
              </button>
            </form>
          </div>
