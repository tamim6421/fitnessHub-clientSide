  ...
  return (
    <div className=" ml-20 md:px-20 mb-20 ">
      <h1 className="text-center pt-10">
        <Title>My Todays Activity</Title>
      </h1>
      ...
      <div className=" w-5/6 mx-auto mb-10 mt-2">
        <Tabs selectedIndex={tabIndex} onSelect={(index) => setTabIndex(index)}>
          <TabList className="bg-purple-400 flex gap-1 flex-wrap justify-center rounded-2xl px-2 py-4 text-white">
            <Tab className="btn btn-sm md:btn md:bg-gray-500 text-white hover:bg-orange-200  ">
              Saturday
            </Tab>
            <Tab className="btn btn-sm md:btn md:bg-gray-500 text-white hover:bg-orange-200  ">
              Sunday{" "}
            ...
            {saturday?.length !== 0 ? (
              <>
                <div className="grid gap-5 grid-cols-1 md:grid-cols-2">
                  {saturday?.map((slot) => (
                    <ClassCard key={slot._id} slot={slot}></ClassCard>
                  ))}
                </div>
              </>
            ) : (
              <>
                ...
                >
                  <div className="card-body box text-lg">
                    <h2 className="text-xl font-bold">No Class Today</h2>

                    <h1>
                      If You want to booked class today please go to ..{" "}
                      <Link
