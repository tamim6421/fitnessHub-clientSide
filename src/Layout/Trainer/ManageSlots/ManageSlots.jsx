...
const ManageSlots = () => {
  ...
  return (
    <div className="px-2 mb-20 md:px-7">
              ...
              <tbody>
                {yourSlot?.map((book, i) => (
                  <tr key={i}>
                    <th>{i + 1}</th>
                    <td>
                      <button className="btn px-9 mb-2 btn-sm bg-green-600 hover:bg-green-700 text-white">
                        {book?.day}
                      </button>
                    </td>
                    <td>
              ...
              <tbody>
                {bookedSlot?.map((book, i) => (
                  <tr key={i}>
                      ...
                      <div className="flex items-center gap-3">
                        <div className="avatar">
                          <div className="mask mask-squircle w-12 h-12">
                            <img
                              src={book?.user?.photoURL}
                              alt="Avatar Tailwind CSS Component"
                            />
                          </div>
                        </div>
                        <div>
                          <div className="font-bold text-lg text- text-purple-600">
                    ...
                    <td>
                      <button className="btn btn-sm px-5 bg-green-200 ">
                        {book?.time}
                      </button>
                    </td>
                    <th>
                      ...
                      <div className="hidden">
                        <form ref={form} onSubmit={sendEmail}>
                          ...
                          <input
                            type="text"
                            defaultValue={book?.user?.displayName}
                            name="member_name"
                          />
                          <label>Email</label>
                          <input
                            defaultValue={book?.user?.email}
                            type="email"
                            name="user_email"
                          />
                          <label>Message</label>
