...
const TotalBalance = () => {
  ...
  useEffect(() => {
    ...
    chartInstance.current = new Chart(myChart, {
      type: "doughnut",
      data: {
        labels: ["Total Subscribers", "Total Paid Member"],
        datasets: [
          {
  ...
  return (
    <div className="mb-10">
      ...
      <div>
        ...
        {/* added pie chart  */}
        <div className="my-16">
          <p className="text-purple-500 text-3xl font-bold text-center mb-10">
            Total Newsletter Subscriber{" "}
            <span className="text-blue-500 text-5xl">VS</span> <br />
            Total Paid Members
          </p>
        ...
        <div className="text-center mb-10">
          <Title>Our Members Payment Transactions</Title>
        </div>
        <div>
