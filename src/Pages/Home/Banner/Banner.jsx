        ...
        <div>
          <div className="hero  text-white">
            <div className="flex h-[100vh] items-center justify-center">
              ...
              <div className='ml-5'>
              <button className='bg-yellow-500 btn btn-outline text-white  px-8 mx-w-max text-center mt-10 rounded-lg py-2 text-lg font-semibold' data-aos="fade-down ">JOIN US NOW</button>  
                </div>                      
              </div>
