...
const BeTrainer = () => {
  ...
  const socialIcons = [
    "https://i.ibb.co/j80F2XK/twitter.png",
    "https://i.ibb.co/vzRtCy2/facebook.png",
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className=" md:flex justify-start gap-2 bg-purple-50 border-2 rounded-sm mt-16  items-center ">
                ...
                <input
                  {...register("skills")}
                  type="checkbox"
                  value="Understanding Anatomy "
                  className="checkbox checkbox-md"
                />{" "}
                <span>Understanding Anatomy </span>
                <input
                  {...register("skills")}
                  type="checkbox"
                  value="Equipment Use"
              ...
              <div className="mt-5">
                ...
                <input
                  ...
                  type="file"
                  className="file-input file-input-bordered w-full bg-purple-200 "
                />
              </div>

              <div className="mt-5">
                <button className="btn bg-purple-400 mt-5 hover:bg-purple-500 w-full text-white">
                  Submit
                </button>
              </div>
            </form>
